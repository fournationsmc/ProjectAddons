...
public class PotionEffectAdapter_1_20_5 implements PotionEffectAdapter {
    ...
    public PotionEffect getInstantHealingEffect(int duration, int strength) {
        return new PotionEffect(PotionEffectType.getByName("INSTANT_HEALTH"), duration / 50, strength);
    }
    ...
    public PotionEffect getNauseaEffect(int duration, int strength) {
        return new PotionEffect(PotionEffectType.getByName("NAUSEA"), duration / 50, strength);
    }
